...
login_bar.send_keys(os.environ.get("LINKEDIN_LOGIN_EMAIL", None))
t.sleep(5)
password_bar = browser.find_element_by_id('login-password')
password_bar.send_keys(os.environ.get("LINKEDIN_PASSWORD", None))
t.sleep(5)
login_bar.submit()
browser.get("https://www.linkedin.com/psettings/member-data")
t.sleep(5)
export_data = browser.find_element_by_class_name(
    "data-export-option-label").click()
t.sleep(5)
